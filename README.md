...
| S004 | 《化工管路设计手册（第二版）》 | 1,159 | 第一章 79 页、第二章 42 页及第三章 133 页的指定修复已独立关闭，来源疑点保留；第四章 89 页已完成分段独审，12 项问题待修复复核；第五章 125 页新稿已交付，独审进行中；全书未完成 |
| S005 | 《化工数据》 | 427 | C02–C12/附录已进入阶段性全局索引；C01 的 3 处引用补漏、前后置页的 5 项书目修复均已独立复核；仍有 23 个书目字段待核，新内容尚未进入全局索引 |
| S006 | 《化工计算与软件应用（第二版）》 | 547 | 第一章 75 页的 2 项修复已独立关闭，26 条来源疑点保留；第二章 97 页独审进行中，第三章 70 页新稿已交付待独审，分别保留 40、32 条来源疑点；软件案例未运行复现，尚未正式入库 |
