...
一句话看进度：**8 份资料的 3,977 页已有页级处理基线；私有工作区的阶段性全局索引只纳入 S005 的部分内容和 S008，尚未完成八源全量入库。** 页数和全局索引数量沿用 2026-08-21 的已核验快照，逐源状态更新至 2026-09-08；进行中的修改不算完成。
...
| ID | 资料 | 页数 | 当前阶段 |
|---|---|---:|---|
| S001 | 《化工原理（上）》 | 371 | 全书候选的结构与映射通过独立检查；一条答案解释修复已独立验收，尚未更新旧候选；全文校订未完成 |
| S002 | 《化工原理（下）》 | 316 | 全书候选的结构与映射通过独立检查；全文校订和逐题答案关联仍需核对 |
| S003 | 《化工过程工程工业实践》 | 177 | 已拆分两条语义根；两章反应工程的公式与图表解释补漏已独立复核，不等于正文和完整表体均已校订；正式整合未完成 |
...
| S007 | 《化工设备设计全书·塔设备》 | 398 | 674 个对象分三批修复；第 1 批通过，第 2 批复核后剩 8 个问题，其定点修复版待独立验收；第 3 批待处理 |
