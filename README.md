...
| S004 | 《化工管路设计手册（第二版）》 | 1,159 | 第一章 79 页、第二章 42 页独审发现的各 1 项解释问题已修复并独立关闭，原有来源疑点保留；第三章 133 页新稿正在独审；全书未完成 |
| S005 | 《化工数据》 | 427 | C02–C12/附录已进入阶段性全局索引；C01 的 3 处引用补漏、前后置页的 5 项书目修复均已独立复核；仍有 23 个书目字段待核，新内容尚未进入全局索引 |
| S006 | 《化工计算与软件应用（第二版）》 | 547 | 第一章 75 页完整独审发现的 2 项问题已修复并独立关闭，26 条来源疑点保留；软件案例未运行复现，整章正式准入与全书处理未完成 |
