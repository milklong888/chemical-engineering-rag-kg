...
| ID | 资料 | 页数 | 当前阶段 |
|---|---|---:|---|
| S001 | 《化工原理（上）》 | 371 | 全书候选的结构与映射通过独立检查；蒸发章 31 页正文与图表已完成独立审阅，仍有 3 项问题待修复；全文内容验收未完成 |
| S002 | 《化工原理（下）》 | 316 | 全书候选的结构与映射通过独立检查；全文校订和逐题答案关联仍需核对 |
| S003 | 《化工过程工程工业实践》 | 177 | 已拆分两条语义根；两章反应工程的公式与图表解释补漏已独立复核，39 页正文与完整表体另已形成冻结待审稿；正式整合未完成 |
| S004 | 《化工管路设计手册（第二版）》 | 1,159 | 第一章 79 页已交付待审稿，独立审阅未结束；第二章 42 页已完成独立审阅，1 处尺寸归属问题待修复；全书验收未完成 |
...
最新待审稿与已验收修复分别记录在 [补充进度](docs/SOURCE_STATUS.md#2026-09-08-补充进度)：生产者完成整理并冻结文件，只代表该版本已交付待审，不算独立验收通过；局部修复通过也不代表整章或整本书通过。
