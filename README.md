...
| ID | 资料 | 页数 | 当前阶段 |
|---|---|---:|---|
| S001 | 《化工原理（上）》 | 371 | 全书语义投影候选已生成、待独立验收；新发现的一条答案解释问题已隔离 |
| S002 | 《化工原理（下）》 | 316 | 全书语义投影候选已生成、待独立验收；逐题答案关联仍需核对 |
...
| S005 | 《化工数据》 | 427 | C02–C12/附录已进入阶段性全局索引；C01 独审发现 3 处漏登引用，待修复；前后置页与参考文献关联处理中 |
