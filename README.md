...
| S003 | 《化工过程工程工业实践》 | 177 | 两章反应工程的 39 页正文独审发现 49 项问题；修复后独立复核已关闭 48 项，尚余 1 处表题同步问题，未获整章准入 |
| S004 | 《化工管路设计手册（第二版）》 | 1,159 | 第一章 79 页完整独审发现 1 项解释问题，修复稿已交付待复核；第二章 42 页的指定修复已独立关闭，30 条来源疑点保留；第三章 133 页新稿已交付待独审；全书未完成 |
